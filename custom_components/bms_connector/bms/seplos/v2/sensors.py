...
async def generate_sensors(hass, bms_type, port, config_battery_address, sensor_prefix, entry, async_add_entities):
        ...
        def native_unit_of_measurement(self):
            if self._calc_function:
                ...
                if isinstance(result, bool):
                    ...
                    return self._unit
            return getattr(super(), "native_unit_of_measurement", None)
    ...
    setting_sensors = [
        ...
        SeplosBMSSensorBase(coordinator, port, "total_pressure_high_pressure_recovery", "Total Pressure and High Pressure Recovery", "V", "mdi:flash-circle", battery_address=battery_address, sensor_prefix=sensor_prefix),
        ...
        SeplosBMSSensorBase(coordinator, port, "total_pressure_low_pressure_recovery", "Total Pressure and Low Pressure Recovery", "V", "mdi:flash-circle", battery_address=battery_address, sensor_prefix=sensor_prefix),
        SeplosBMSSensorBase(coordinator, port, "total_voltage_overvoltage_protection", "Total Voltage Overvoltage Protection (V)", "V", "mdi:flash-circle", battery_address=battery_address, sensor_prefix=sensor_prefix),
        ...
        SeplosBMSSensorBase(coordinator, port, "ambient_low_temperature_alarm", "Ambient Low Temperature Warning", "°C", "mdi:thermometer-alert", battery_address=battery_address, sensor_prefix=sensor_prefix),
        ...
        SeplosBMSSensorBase(coordinator, port, "overcurrent_recovery_times", "Overcurrent Delay Recovery Times", "times", "mdi:timer-sand", battery_address=battery_address, sensor_prefix=sensor_prefix),
